  ...
  return (
    <div className="relative bg-black w-screen overflow-x-hidden flex flex-col lg:flex-row min-h-screen mt-24">
      ...
      <div className="relative w-full lg:w-1/2 h-[60vh] sm:h-[80vh] lg:h-screen">
        ...
        <p className="absolute top-14 sm:top-24 left-5 sm:left-6 lg:left-7 text-sm sm:text-lg text-white tracking-tighter font-sans">
          Believe In Charity
        </p>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center text-center px-6 py-12">
        ...
        <ul className="mt-12 space-y-10 text-base sm:text-lg md:text-xl lg:text-2xl text-white text-left list-disc list-outside max-w-[80%] lg:max-w-[60%] sm:max-w-[80%]">
