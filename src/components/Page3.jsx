...
const Page3 = () => {
  return (
    <div className="relative bg-black min-h-screen w-screen overflow-x-hidden">
      ...
      <div className="relative mt-20 sm:mt-28 text-white z-10 h-auto w-screen overflow-y-hidden flex items-center justify-center px-4 sm:px-8 md:px-12">
        <video
          ...
          loop
        />
        <h1 className="absolute text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-CanvaSans font-black tracking-tighter text-center">
